...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, zavrsni.erasmus.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, zavrsni.erasmus.repository.UserRepository.USERS_BY_EMAIL_CACHE);
