 ...
 */
public final class HHeaderUtil {

    private static final Logger log = LoggerFactory.getLogger(HHeaderUtil.class);
    ...
    public static HttpHeaders createEntityCreationAlert(
        ...
        String message = enableTranslation
            ...
            : "Novi " + entityName + " je napravljen pod brojem " + param;
    ...
    public static HttpHeaders createEntityUpdateAlert(String applicationName, boolean enableTranslation, String entityName, String param) {
        String message = enableTranslation
            ...
            : entityName + " pod brojem " + param + " je ureden";
        return createAlert(applicationName, message, param);
    }
    ...
    public static HttpHeaders createEntityDeletionAlert(
        ...
        String message = enableTranslation
            ...
            : entityName + " pod brojem " + param + " je obrisan ";
        return createAlert(applicationName, message, param);
    }
