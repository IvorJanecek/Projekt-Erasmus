...
import static zavrsni.erasmus.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import zavrsni.erasmus.repository.AuthorityRepository;
...
import zavrsni.erasmus.service.dto.PasswordChangeDTO;
import zavrsni.erasmus.service.dto.UserDTO;
import zavrsni.erasmus.web.rest.vm.KeyAndPasswordVM;
import zavrsni.erasmus.web.rest.vm.ManagedUserVM;
